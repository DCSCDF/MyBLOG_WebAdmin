        ...
        <div
            :class="['relative !backdrop-blur-md bg-white/80 lg:bg-transparent flex flex-col transition-all duration-300 ease-in-out h-full border-r border-gray-200', collapsed ? 'w-20' : 'w-60']">
                ...
                <div class="flex-1 flex flex-col overflow-y-auto">
                        <div
                            class="h-14 w-full flex flex-row items-center px-auto border-b border-gray-200">
                                <div v-if="collapsed" class="mx-auto">
                                        <svg class="icon" height="33"
                                ...
                                <!--                                </h1>-->
                                <div v-if="!collapsed">
                                        <div class="flex mx-6 items-center w-full">
                                                <svg class="icon" height="33" viewBox="0 0 1024 1024" width="33"
